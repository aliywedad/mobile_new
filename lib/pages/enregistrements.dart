        ...
        Row(
          ...
          children: [
            TextButton(
              ...
              child: Text("Annuler"), // Translated "cancel" to French
            ),
            TextButton(
              onPressed: () async {
                showDialog(
                      ...
                      Row(
                        ...
                        children: [
                          TextButton(
                            ...
                            child: Text("Non"), // Translated "no" to French
                          ),
                          TextButton(
                            onPressed: () async {
                              int delet_reponses = await db().delete(
                              ...
                              Navigator.of(context).pop(); // Close the parent dialog
                            },
                            child: Text("Oui"), // Translated "yes" to French
                          )
                        ],
                      )
                    ],
              ...
              child: Text("Supprimer"), // Translated "delete" to French
            ),
          ],
        )
      ],
